...
public class CacheResultAspect {
    ...
    public Object aroundAllMethodMarkCacheResultAnnotationAdvice(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        if (methodArgsObjectMap != null) {
            ...
            if (result != null) {
                log.info("Return result form cache: method: {}({}), result: {}", methodName, proceedingJoinPoint.getArgs(), result);
                return result;
            } else {
    ...
    @Pointcut("@annotation(ru.iteco.aspecthomework.externalServiceApplication.model.CacheResult)")
    public void allMethodMarkCacheResultAnnotation() {}

    private MethodArgs getMethodArgs(Object[] args) {
        LinkedList<Object> linkedList = new LinkedList<>();
        Collections.addAll(linkedList, args);
        return new MethodArgs(linkedList);
    }
